...
must be measured by that of many others relating to the Spartan Confucius.`
  },
  {
    ...
    author: "Lewis Caroll",
    content:`Either the well was very deep, or she fell very slowly, for she had
    ...
    a heap of sticks and dry leaves, and the fall was over. The King and Queen of Hearts were seated on their throne when they
    ...
    her, to pass away the time. As soon as the jury had a little recovered from the shock of being
  ...
  },
  {
    name:"Dracula",
    author:"Bram Stoker",
    content:`_4 May._--I found that my landlord had got a letter from the Count,
...
coach! As we wound on our endless way, and the sun sank lower and lower behind
...
was found imbedded in the hump. Lord save me, thinks I, that must be the harpooneer, the infernal
...
than ever I bolted a dinner. I now screwed my eyes hard towards the half hidden image, feeling but
...
as carelessly as if he were a sportsman bagging a dead woodcock. Now, take away the awful fear, and my sensations at feeling the
...
worth unusual regarding. But, besides the Feegeeans, Tongatobooarrs, Erromanggoans, Pannangians,
...
Here comes another with a sou'-wester and a bombazine cloak.No town-bred dandy will compare with a country-bred one—I mean a
...
buttons, and all, down the throat of the tempest.But think not that this famous town has only harpooneers, cannibals,
